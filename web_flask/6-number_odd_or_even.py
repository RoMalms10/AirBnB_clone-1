...
""" This module will import flask for a web application.
    ...
    - One route is /number_template/<n> and will only accept a number. It will
    call a function that displays an HTML page only if n is a number.
    - One route is /number_odd_or_even/<n> and will only accept a number. It
    will call a function that displays an HTML page displaying the number 
    and whether or not it is odd or even.
"""
...
def display_html_odd_or_even(n):
    """ Displays an HTML page that displays whether or not n is odd/even """
